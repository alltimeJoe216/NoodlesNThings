...
class OrderCollectionViewCell: UICollectionViewCell, UICollectionViewDataSource, UICollectionViewDelegate,UICollectionViewDelegateFlowLayout  {
    ...
    func setColViewSize() {
        ...
        colViewSize.register(UINib(nibName: "ItemSizeCollectionViewCell", bundle: nil), forCellWithReuseIdentifier: "ItemSizeCollectionViewCell")
